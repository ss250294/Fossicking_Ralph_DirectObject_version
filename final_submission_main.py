...
class World(DirectObject):
    ...
    def __init__(self):
        ...
        self.environ1 = loader.loadModel("models/env")
        self.environ1.reparentTo(render)
        self.environ1.setScale(50,50,30)
        self.environ1.setPos(0, -170, -3)
        #self.environ1.setHpr(90,0,0)
		
        self.chair1=loader.loadModel("models/BeachChair")
        #self.chair1=self.reaparentTo(render)
        #self.setScale(1000)
        #self.setPos(25,-160,-3)
        #self.chair1.setHpr(90,0,0)
        self.house1 = loader.loadModel("models/houses/church")
        self.house1.reparentTo(render)
        self.house1.setScale(0.30)
        self.house1.setPos(25, -150, -3)
        self.house1.setHpr(90,0,0)
        self.house2 = loader.loadModel("models/houses/building")
        self.house2.reparentTo(render)
        self.house2.setScale(0.30)
        self.house2.setPos(18, -200, -3)
        self.house2.setHpr(180,0,0)
        self.house3 = loader.loadModel("models/houses/farmhouse")
        self.house3.reparentTo(render)
        self.house3.setScale(0.30)
        self.house3.setPos(20, -130, -3)
        self.house3.setHpr(90,0,0)
        self.house4 = loader.loadModel("models/houses/dojo")
        self.house4.reparentTo(render)
        self.house4.setScale(0.05)
        self.house4.setPos(5, -220, -3)
        self.house5 = loader.loadModel("models/houses/beachhouse2")
        self.house5.reparentTo(render)
        self.house5.setScale(0.30)
        self.house5.setPos(-10, -180, -3)
        self.house5.setHpr(-90,0,0)

        self.house6 = loader.loadModel("models/houses/gazebo")
        self.house6.reparentTo(render)
        self.house6.setScale(0.50)
        self.house6.setPos(-10, -200, -3)
        self.house7 = loader.loadModel("models/houses/building")
        self.house7.reparentTo(render)
...
##        render.setFog(self.fog)
        ...
        for x in range(10):
          ...
          self.banana[x].reparentTo(render)

        self.banana[11] = loader.loadModel("models/banana/banana")
        self.banana[11].reparentTo(render)
        self.banana[11].setPos(12, 8, -2)
        self.banana[12] = loader.loadModel("models/banana/banana")
        self.banana[12].reparentTo(render)
        self.banana[12].setPos(0, 120, -2)
        self.banana[13] = loader.loadModel("models/banana/banana")
        self.banana[13].reparentTo(render)
        self.banana[13].setPos(12, 100, -2)
        self.banana[14] = loader.loadModel("models/banana/banana")
        self.banana[14].reparentTo(render)
        self.banana[14].setPos(22, 80, -2)
        self.banana[15] = loader.loadModel("models/banana/banana")
        self.banana[15].reparentTo(render)
        self.banana[15].setPos(12, 50, -2)
        self.banana[16] = loader.loadModel("models/banana/banana")
        self.banana[16].reparentTo(render)
        self.banana[16].setPos(15, 30, -2)
        self.banana[17] = loader.loadModel("models/banana/banana")
        self.banana[17].reparentTo(render)
        self.banana[17].setPos(-10, 8, -2)
        self.banana[18] = loader.loadModel("models/banana/banana")
        self.banana[18].reparentTo(render)
        self.banana[18].setPos(-20, -30, -2)
        self.banana[19] = loader.loadModel("models/banana/banana")
        self.banana[19].reparentTo(render)
        self.banana[19].setPos(-50, -50, -2)
        
        self.candy = loader.loadModel("models/candy/candycane2")
        self.candy.reparentTo(render)
        self.candy.setScale(0.001)
        self.candy.setPos(-6, 10, -2)

        self.fire = loader.loadModel("models/candy/candycane2")
        self.fire.reparentTo(render)
        self.fire.setScale(0.001)
        self.fire.setPos(0, 2, -2)

        self.ball = [None for i in range(8)]
        self.ball[0] = loader.loadModel("models/ball/soccerball")
        self.ball[0].reparentTo(render)
        self.ball[0].setPos(-6, 6, -2)
        self.ball[0].setScale(0.7)
        self.ball[1] = loader.loadModel("models/ball/soccerball")
        self.ball[1].reparentTo(render)
        self.ball[1].setPos(-6, -6, -2)
        self.ball[1].setScale(0.7)
        self.ball[2] = loader.loadModel("models/ball/soccerball")
        self.ball[2].reparentTo(render)
        self.ball[2].setPos(-15, 10, -2)
        self.ball[2].setScale(0.7)
        self.ball[3] = loader.loadModel("models/ball/soccerball")
        self.ball[3].reparentTo(render)
        self.ball[3].setPos(-19, 0, -2)
        self.ball[3].setScale(0.7)
        self.ball[4] = loader.loadModel("models/ball/soccerball")
        self.ball[4].reparentTo(render)
        self.ball[4].setPos(-6, -20, -2)
        self.ball[4].setScale(0.7)
        self.ball[5] = loader.loadModel("models/ball/soccerball")
        self.ball[5].reparentTo(render)
        self.ball[5].setPos(6, 6, -2)
        self.ball[5].setScale(0.7)
        self.ball[6] = loader.loadModel("models/ball/soccerball")
        self.ball[6].reparentTo(render)
        self.ball[6].setPos(19, 10, -2)
        self.ball[6].setScale(0.7)
        self.ball[7] = loader.loadModel("models/ball/soccerball")
        self.ball[7].reparentTo(render)
        self.ball[7].setPos(-15, 12, -2)
        self.ball[7].setScale(0.7)

        self.rock = [None for i in range(8)]
        self.rock[0] = loader.loadModel("models/greencrystal")
        self.rock[0].reparentTo(render)
        self.rock[0].setPos(0,306, -2)
        self.rock[0].setScale(0.007)
        self.rock[0].setHpr(90,0,0)
        self.rock[1] = loader.loadModel("models/greencrystal")
        self.rock[1].reparentTo(render)
        self.rock[1].setPos(-2, 150, -3)
        self.rock[1].setScale(0.007)
        self.rock[1].setHpr(90,0,0)
        self.rock[2] = loader.loadModel("models/greencrystal")
        self.rock[2].reparentTo(render)
        self.rock[2].setPos(-10, 10, -3)
        self.rock[2].setScale(0.007)
        self.rock[2].setHpr(90,0,0)
        self.rock[3] = loader.loadModel("models/greencrystal")
        self.rock[3].reparentTo(render)
        self.rock[3].setPos(5, 0, -3)
        self.rock[3].setScale(0.007)
        self.rock[3].setHpr(90,0,0)
        self.rock[4] = loader.loadModel("models/greencrystal")
        self.rock[4].reparentTo(render)
        self.rock[4].setPos(-2, -120, -3)
        self.rock[4].setScale(0.007)
        self.rock[4].setHpr(90,0,0)

        self.tire = loader.loadModel("models/tire/tire")
        self.tire.reparentTo(render)
        self.tire.setScale(0.25, 0.25, 0.25)
        self.tire.setPos(-20, 3, -2)
        
        self.bunny1 = loader.loadModel("models/bunny")
        self.bunny1.reparentTo(render)
        self.bunny1.setScale(0.2)
        self.bunny1.setPos(15, -160, -3)
        self.bunny1.setHpr(-60,0,0)
        self.bunny2 = loader.loadModel("models/bunny")
        self.bunny2.reparentTo(render)
...
def start():
	...
	frame.destroy()
def helpe():
	base.inst1 = addInstructions(0.95, "[ESC]: Quit")
	base.inst2 = addInstructions(0.90, "[Left-Arrow]: Rotate Plane Left")
	base.inst3 = addInstructions(0.85, "[Right-Arrow]: Rotate Plane Right")
	base.inst4 = addInstructions(0.80, "[Up-Arrow]: Run Plane Forward")
	base.boolean=0
	d.destroy()       
base.boolean=1
frame = DirectFrame(image="game.jpg",frameSize=(-3,3,-3,3),image_scale=(2,2,2))
b = DirectButton(text="Start Game", scale=0.1,command=start)
b.setPos(-.3,.9,0)

c = DirectButton(text="Quit",scale = 0.1,command=sys.exit)
c.setPos(.9,-2.7,0)

d=DirectButton(text="Help",scale=0.1,command=helpe)
d.setPos(.3,-.9,0)
#w = World()
#run()
